  ...
  Hooks.on(
    ...
    (_menu: any, dropdowns: any) => {
      ...
      const entries = [
        ...
        {
          action: "lgc-box-statblock-influence",
          title: "Statblock : influence",
          icon: '<i class="fa-solid fa-people-arrows></i>',
          cmd: insertHtmlCommand(
            [
              '<div class="lgc-box-text statblock-influence">',
              '    <h4 class="statblock-influence__name">NOM DU PNJ</h4>',
              ...
              "        </section>",
              "        <p>Description</p>",
              "        <p><strong>Perception</strong> +9</p>",
              "        <p><strong>Volonté</strong> +12</p>",
              "        <hr>",
              "        <p><strong>Historique</strong> TODO</p>",
              "        <p><strong>Apparence</strong> TODO</p>",
              "        <p><strong>Personnalité</strong> TODO</p>",
              "        <p><strong>Oral, signe distinctif</strong> TODO</p>",
              "        <hr>",
              "        <p><strong>Découverte</strong> Connaissances (Commerce) DD 12, Société DD 18, Perception DD 22</p>",
              "        <p><strong>Compétences d'influence</strong> Connaissances (Commerce) DD 16, Performance DD 16, Société DD 18, Duperie DD 20, Diplomatie DD 22</p>",
              ...
              "        <p><strong>Résistances</strong> Tenter de l'émouvoir (+2).</p>",
              "        <p><strong>Faiblesses</strong> Papéterie (-2).</p>",
              "    </section>",
              "</div>",
              "<p></p>",
            ].join("\n"),
